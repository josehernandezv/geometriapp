...
class parallelogramPerimeterView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        ...
                        <Text style={TYPO.paperFontHeadline}>2 x {this.roundNumber(parseFloat(this.state.a) + parseFloat(this.state.b))}</Text>                        
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(2 * (parseFloat(this.state.a) + parseFloat(this.state.b)))}</Text>                        
                    </View>
                </CardItem>
            </Card>
        );
...
module.exports = parallelogramPerimeterView;