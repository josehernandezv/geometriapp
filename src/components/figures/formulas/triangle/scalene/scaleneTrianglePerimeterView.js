...
class scaleneTrianglePerimeterView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>a + b + c</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(this.state.a)} + {this.roundNumber(this.state.b)} + {this.roundNumber(this.state.c)} </Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(parseFloat(this.state.a) + parseFloat(this.state.b) + parseFloat(this.state.c))}</Text>                   
                    </View>
                </CardItem>
            </Card>
        );
...
module.exports = scaleneTrianglePerimeterView;