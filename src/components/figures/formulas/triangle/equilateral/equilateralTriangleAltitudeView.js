...
class equilateralTriangleAltitudeView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>(√3 x l)/2</Text>
                        <Text style={TYPO.paperFontHeadline}>(√3 x {this.roundNumber(this.state.side)})/2</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(Math.sqrt(3) * this.state.side)} / 2</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber((Math.sqrt(3) * this.state.side) / 2)}</Text>                        
                    </View>
                </CardItem>
            </Card>
...
module.exports = equilateralTriangleAltitudeView;