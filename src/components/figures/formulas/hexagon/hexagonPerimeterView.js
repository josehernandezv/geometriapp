...
class hexagonPerimeterView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>6 x l</Text>
                        <Text style={TYPO.paperFontHeadline}>6 x {this.roundNumber(this.state.side)}</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(6 * this.state.side)}</Text>                        
                    </View>
                </CardItem>
            </Card>
        );
...
module.exports = hexagonPerimeterView;