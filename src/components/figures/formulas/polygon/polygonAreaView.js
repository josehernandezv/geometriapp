            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>(P x ap) / 2</Text>
                        <Text style={TYPO.paperFontHeadline}>({this.roundNumber(this.state.a)} x {this.roundNumber(this.state.b)}) / 2</Text>
                        <Text style={TYPO.paperFontHeadline}>({this.roundNumber(this.state.a * this.state.b)}) / 2</Text>                        
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber((this.state.a * this.state.b)/2)}</Text>                    
                    </View>
                </CardItem>
            </Card>
