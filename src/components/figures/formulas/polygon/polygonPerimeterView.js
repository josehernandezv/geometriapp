...
class pentagonPerimeterView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>n x l</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(this.state.a)} x {this.roundNumber(this.state.b)}</Text>                        
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(this.state.a * this.state.b)}</Text>                                                  
                ...
                <Container>
                    <Content>
                        <Form>
                            ...
                            <Item floatingLabel>
                                <Label>Distancia del lado</Label>
                                <Input keyboardType='numeric'
...
module.exports = pentagonPerimeterView;