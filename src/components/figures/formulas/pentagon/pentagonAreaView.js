...
class pentagonAreaView extends Component {
            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>(5 x l x ap) / 2</Text>
                        <Text style={TYPO.paperFontHeadline}>(5 x {this.roundNumber(this.state.a)} x {this.roundNumber(this.state.b)}) / 2</Text>
                        <Text style={TYPO.paperFontHeadline}>(5 x {this.roundNumber(this.state.a * this.state.b)}) / 2</Text>                        
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(5 * this.state.a * this.state.b)} / 2</Text>                     
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber((5 * this.state.a * this.state.b)/2)}</Text>                    
                    </View>
                </CardItem>
            </Card>
...
module.exports = pentagonAreaView;