            ...
            <Card height={300} alignItems='center'>
                <CardItem>
                    <View alignItems='center'>
                        <Text style={TYPO.paperFontHeadline}>5 x l</Text>
                        <Text style={TYPO.paperFontHeadline}>5 x {this.roundNumber(this.state.side)}</Text>
                        <Text style={TYPO.paperFontHeadline}>{this.roundNumber(5 * this.state.side)}</Text>                        
                    </View>
                </CardItem>
            </Card>
        );
