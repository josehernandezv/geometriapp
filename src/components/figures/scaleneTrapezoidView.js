...
class scaleneTrapezoidView extends Component {
            ...
            <Container style={{backgroundColor: '#F5FCFF'}}>
                <Content>
                    <View style={styles.container}>
                        <Image style={styles.image}  source={require('../../images/figures/scaleneTrapezoid.png')} />
                        ...
                        <TouchableHighlight underlayColor={'transparent'} onPress={() => this.openView('trapezoidAreaView', 'Área del trapecio')}>
                            ...
                            <View style={{flex: 3}}>
                                <Text style={[TYPO.paperFontHeadline, COLOR.paperGrey900]}>h x (B + b / 2)</Text>   
                            </View>   
                            </View>
                        </TouchableHighlight>
...
module.exports = scaleneTrapezoidView;