                ...
                <Content>
                    <View style={styles.container}>
                        ...
                        <TouchableHighlight underlayColor={'transparent'} onPress={() => this.openView('pentagonAreaView', 'Área del pentágono')}>
                            ...
                            <View style={{flex: 3}}>
                                <Image style={{height: 60, width: 120, resizeMode: 'contain'}} source={require('../../images/formulas/pentagon/area.png')} />                                                                                                                                   
                            </View>   
                            </View>
                        </TouchableHighlight>
                        ...
                        <TouchableHighlight underlayColor={'transparent'} onPress={() => this.openView('pentagonPerimeterView', 'Perímetro del pentágono')}>
                            ...
                            <View style={{flex: 3}}>
                                <Image style={{height: 30, width: 120, resizeMode: 'contain'}} source={require('../../images/formulas/pentagon/perimeter.png')} />                                                                                                                                     
                            </View>   
                            </View>
                        </TouchableHighlight>
